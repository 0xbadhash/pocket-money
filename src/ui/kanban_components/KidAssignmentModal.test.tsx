...
vi.mock('../../contexts/UserContext', async () => {
  const actual = await vi.importActual('../../contexts/UserContext') as Record<string, unknown>;
  return {
    ...actual,
...
vi.mock('../../contexts/ChoresContext', async () => {
  const actual = await vi.importActual('../../contexts/ChoresContext') as Record<string, unknown>;
  return {
    ...actual,
