...
describe('KanbanSettingsView', () => {
  ...
  test('reorders columns on drag end', async () => {
    ...
    const dragEndEvent: DragEndEvent = { // Type DragEndEvent from @dnd-kit/core
      active: { id: 'cfgC', data: { current: { sortable: { index: 2, containerId: kid1Id } } } } as unknown as typeof dragEndEvent.active,
      over: { id: 'cfgA', data: { current: { sortable: { index: 0, containerId: kid1Id } } } } as unknown as typeof dragEndEvent.over,
