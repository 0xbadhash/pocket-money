...
import type { User, Kid, KanbanColumnConfig } from '../types';
...
export interface UserContextType {
  ...
  // Kanban column config methods are now available via useKanbanColumns hook
  // getKanbanColumnConfigs, addKanbanColumnConfig, etc. deprecated from context
}
...
export const UserProvider: React.FC<UserProviderProps> = ({ children }) => {
  ...
  // Kanban column configuration methods extracted to useKanbanColumns hook
  // These are now implemented in the hook for better composability
